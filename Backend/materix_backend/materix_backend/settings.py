"""
Django settings for materix_backend project.
...
SECRET_KEY = 'django-insecure-=v^3^bfd!oa^mo5tml+_%zgy&3&a-tlf+g%30r*qvs_xv-y!ky'
...
ROOT_URLCONF = 'materix_backend.urls'
...
WSGI_APPLICATION = 'materix_backend.wsgi.application'
...
# Simple JWT (tweak lifetimes as you wish)
